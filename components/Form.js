...
//     const response = await fetch("/api/posts/index.js", {
//       method: "POST",
//       body: JSON.stringify({
//         input: input,
//         photoUrl: photoUrl,
...
//     {/* post button */}
//     <button className="absolute bottom-0 right-0 font-medium bg-blue-400 hover:bg-blue-500 
