...
function Input() {
    ...
    return <div className="bg-white dark:bg-[#1d2226] rounded-lg p-3 space-y-3 border
    border-gray dark:border-none">
        ...
        <div className="flex items-center flex-wrap gap-4 justidy-center md:gap-x-10">
            ...
            <button className="inputButton group">
                <BusinessCenterIcon className="text-blue-400" />
