...
function Sidebar() {
    ...
    return <div className="space-y-2 min-w-max max-w-lg">
        {/* top */}
        ...
        flex-col items-center text-center border border-gray-300 dark:border-none">
            ...
            {/* serverside rendering of session */}
            <Avatar
                onClick={signOut}
            ...
            <div className="hidden  md:inline text-left dark:text-white/75 text-sm">
                ...
                <div className="sidebarButton">
                    <h4 claassName="text-xs">
                        Access exclusive tools and insights
                    </h4>
                    <h4 className="dark:text-white font-medium">
                        <span className="w-3 h-3 bg-gradient-to-tr from-yellow-700 to-yellow-200 
        ...
        dark:text-white/75 rounded-lg overflow-hidden flex-col space-y pt-2.5 sticky top-20
